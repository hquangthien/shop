...
@section('content')
    <div class="col-sm-9 padding-right">
        <div class="features_items"><!--features_items-->
            ...
            <h2 class="title text-center">{{ $objCat->name }}</h2>
            <div class="row">
                <div class="col-md-3">
                    <?php
                    ...
                    <select id="cat_filter" class="filter form-control">
                        ...
                        <option @if($objCat->parrent_cat == '') selected @endif value="all">Tất cả danh mục</option>
                        @foreach($objSubCat1[$catId] as $subCat)
                            <option @if($objCat->id == $subCat->id) selected
                                    @endif value="{{ $subCat->id }}">{{ $subCat->name }}</option>
                        @endforeach
                    </select>
                </div>
                <div class="col-md-3">
