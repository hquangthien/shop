                            ...
                            <table class="table m-0 table-bordered">
                                ...
                                @foreach($objContact as $contactItem)
                                    <tr @if($contactItem->readed == 0) style="font-weight: bold; background-color: #ebeff2" @endif>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.contact.show', ['id' => $contactItem->id]) }}" class="on-default edit-row"><i class="fa fa-paper-plane"></i></a> ||
                                            <a href="{{ route('admin.contact.delete', ['id' => $contactItem->id]) }}"
