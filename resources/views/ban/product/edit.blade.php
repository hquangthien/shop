                    ...
                    <div class="card-box">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                @endif
                                <form id="create_news" class="form-horizontal" action="{{ route('ban.product.update', ['id' => $objProduct->id]) }}" method="POST" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="form-group">
                                        <label class="col-md-2 control-label">Tên sản phẩm (*)</label>
                                        <div class="col-md-10">
                                            <input type="text" class="form-control" value="{{ $objProduct->name }}" name="name" placeholder="Nhập tên sản phẩm...">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <select class="form-control" name="cat_id">
                                                ...
                                                @foreach($objSuperCat as $superCat)
                                                    <option @if($objProduct->cat_id == $superCat->id) selected @endif value="{{ $superCat->id }}">{{ $superCat->name }}</option>
                                                    @if(isset($objSubCat1[$superCat->id]))
                                                        @foreach($objSubCat1[$superCat->id] as $subCat1)
                                                            <option @if($objProduct->cat_id == $subCat1->id) selected @endif value="{{ $subCat1->id }}"> + {{ $subCat1->name }}</option>
                                                            @if(isset($objSubCat2[$subCat1->id]))
                                                                @foreach($objSubCat2[$subCat1->id] as $subCat2)
                                                                    <option @if($objProduct->cat_id == $subCat2->id) selected @endif value="{{ $subCat2->id }}"> &nbsp;&nbsp;&nbsp; - {{ $subCat2->name }}</option>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" id="price" value="{{ $objProduct->price }}" name="price" class="form-control" placeholder="Nhập giá sản phẩm...">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="new" value="{{ $objProduct->new }}" class="form-control" placeholder="Tình trạng sản phẩm (mới, cũ, like new ...)">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <input type="text" name="tags" value="@foreach($objTags as $tags){{$tags->content}},@endforeach"  data-role="tagsinput" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-2 control-label" for="picture">Ảnh cũ</label>
                                        <div class="col-md-10">
                                            <img src="{{ Storage::url('app/files/') }}{{ $objProduct->picture }}" alt="">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-10">
                                            <textarea class="form-control" name="description" id="editor" rows="5">{!! $objProduct->description !!}</textarea>
                                        </div>
                                    </div>
