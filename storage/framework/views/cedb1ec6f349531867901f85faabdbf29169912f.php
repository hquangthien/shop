...
<div class="wrapper-page">
    ...
    <div class="m-t-40 card-box">
        ...
        <div class="panel-body text-center">
            <img src="<?php echo e($adminUrl); ?>assets/images/mail_confirm.png" alt="img" class="thumb-lg m-t-20 center-block">
            <form class="form-horizontal m-t-20" action="<?php echo e(route('register.store')); ?>" method="POST">
                <?php echo e(csrf_field()); ?>

                <p class="text-muted font-13 m-t-20"> Mã xác nhận đã được gửi đến
                    <b><?php echo e($email); ?></b>. Vui lòng check email và điền mã xác nhận tại đây để hoàn tất đăng ký tài khoản.
                </p>
                <input class="form-control" name="username" type="hidden" value="<?php echo e($username); ?>">
